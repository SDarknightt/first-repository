...
const Footer = () => {
  return (
    ...
    <footer className="bg-white dark:bg-green-700 ">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-5">
          <div className="sm:flex sm:items-center sm:justify-center">
              <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                  <a href="https://www.facebook.com/samuel.diasoliveira.165/" className="text-white hover:text-gray-900 dark:hover:text-black">
                  ...
                  <a href="https://www.instagram.com/samu_d03/" className="text-white hover:text-gray-900 dark:hover:text-black">
                  ...
                  <a href="https://github.com/SDarknightt" className="text-white hover:text-gray-900 dark:hover:text-black">
